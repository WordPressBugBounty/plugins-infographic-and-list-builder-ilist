<?php 
wp_enqueue_style( 'ilist_img3_stylesheet', OCOPD_TPL_URL1 . "/$template_code/css/style.css");
wp_enqueue_style( 'ilist_img3_stylesheet_responsive', OCOPD_TPL_URL1 . "/$template_code/css/responsive.css");
...
wp_enqueue_style( 'ilist_img3_google_font2', "https://fonts.googleapis.com/css?family=Montserrat");
?>
<?php 
...
<div id="qcld-list-holder" class="qcld-list-hoder">
	...
	<?php foreach($list_sl as $list) : ?>
		<li id="qcld_sl_<?php echo get_the_ID()."_".$cnt ?>" class="ilist_img3_list-style-six ilist_img3_listy-style-six-01 ilist_img3_qcld_column<?php echo esc_html__($column); ?>">
			<div class="ilist_img3_qcld_style"><!--col-md-6 col-sm-6-->

				<div class="ilist_img3_list-inner-part-six">
					<?php if( isset( $list['qcld_text_image'] ) && !empty( $list['qcld_text_image'] ) ){ ?> 
					<a class="example-image-link ilist_img3_center" href="<?php echo isset($list['qcld_text_image']) ? esc_url($list['qcld_text_image']):''; ?>" data-lightbox="example-<?php echo $cnt;?>">
						<img class="ilist_img3_example-image" src="<?php echo isset($list['qcld_text_image']) ? esc_url($list['qcld_text_image']):''; ?>" alt="image-1" />
					</a>
					<?php } ?>
					 <div class="ilist_img3_effect-style-six">
						<?php 
