...
wp_enqueue_style( 'ilist_infog5_light_css', QCOPD_iList_ASSETS_URL1 . "/css/lightbox.min.css");
wp_enqueue_script( 'ilist_infog5_light', QCOPD_iList_ASSETS_URL1 . "/js/lightbox-plus-jquery.min.js", array('jquery'));
?>
<?php 
if($column>8){
	$column = 8;
