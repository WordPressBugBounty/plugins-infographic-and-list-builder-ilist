...
add_filter('qcld_ilist_floating_openai_filter_for_style', 'qcld_ilist_floating_help_openai_filter_for_style', 10, 2);
if ( ! function_exists( 'qcld_ilist_floating_help_openai_filter_for_style' ) ) {
function qcld_ilist_floating_help_openai_filter_for_style($qcld_writing_style, $qcld_language){
...
add_filter('qcld_ilist_floating_openai_filter_for_tone', 'qcld_ilist_floating_help_openai_filter_for_tone', 10, 2);
if ( ! function_exists( 'qcld_ilist_floating_help_openai_filter_for_tone' ) ) {
function qcld_ilist_floating_help_openai_filter_for_tone($qcld_writing_tone, $qcld_language){
...
add_filter('qcld_ilist_floating_openai_article_heading_tag', 'qcld_ilist_floating_openai_article_heading_tag_callback', 10, 8 );
if ( ! function_exists( 'qcld_ilist_floating_openai_article_heading_tag_callback' ) ) {
function qcld_ilist_floating_openai_article_heading_tag_callback( $allresults, $mylist, $myprompt, $qcld_ilist_article_heading_tag, $style_text, $tone_text, $avoid_text, $qcld_ilist_article_label_word_to_avoid ){
    ...
    if( isset($mylist) && !empty($mylist) ) {
        ...
        foreach ( $mylist as $key => $value ) {
            ...
            if ( $qcld_ilist_article_heading_tag == "h1" ) {
                $result = "\n"."<h1>" . $value . "</h1>" ."\n". $complete;
            } elseif ( $qcld_ilist_article_heading_tag == "h2" ) {
                $result = "\n"."<h2>" . $value . "</h2>" ."\n". $complete;
            } elseif ( $qcld_ilist_article_heading_tag == "h3" ) {
                $result = "\n"."<h3>" . $value . "</h3>" ."\n". $complete;
            } elseif ( $qcld_ilist_article_heading_tag == "h4" ) {
                $result = "\n"."<h4>" . $value . "</h4>" ."\n". $complete;
            } elseif ( $qcld_ilist_article_heading_tag == "h5" ) {
                $result = "\n"."<h5>" . $value . "</h5>" ."\n". $complete;
            } elseif ( $qcld_ilist_article_heading_tag == "h6" ) {
                $result = "\n"."<h6>" . $value . "</h6>" ."\n". $complete;
            } else {
                $result = "\n"."<h2>" . $value . "</h2>" ."\n". $complete;
            }
...
add_filter('qcld_ilist_floating_openai_article_heading_intro', 'qcld_ilist_floating_openai_article_heading_intro_callback', 10, 3 );
if ( ! function_exists( 'qcld_ilist_floating_openai_article_heading_intro_callback' ) ) {
function qcld_ilist_floating_openai_article_heading_intro_callback( $allresults, $myintro, $introduction ){
...
add_filter('qcld_ilist_floating_openai_article_heading_faq', 'qcld_ilist_floating_openai_article_heading_faq_callback', 10, 3 );
if ( ! function_exists( 'qcld_ilist_floating_openai_article_heading_faq_callback' ) ) {
function qcld_ilist_floating_openai_article_heading_faq_callback( $allresults, $faq_text, $faq_heading ){
...
add_filter('qcld_ilist_floating_openai_article_heading_conclusion', 'qcld_ilist_floating_openai_article_heading_conclusion_callback', 10, 3 );
if ( ! function_exists( 'qcld_ilist_floating_openai_article_heading_conclusion_callback' ) ) {
function qcld_ilist_floating_openai_article_heading_conclusion_callback( $allresults, $myconclusion, $conclusion ){
...
add_filter('qcld_ilist_floating_openai_article_heading_tagline', 'qcld_ilist_floating_openai_article_heading_tagline_callback', 10, 3 );
if ( ! function_exists( 'qcld_ilist_floating_openai_article_heading_tagline_callback' ) ) {
function qcld_ilist_floating_openai_article_heading_tagline_callback( $allresults, $mytagline, $conclusion ){
...
add_filter('qcld_ilist_floating_openai_article_heading_img', 'qcld_ilist_floating_openai_article_heading_img_callback', 10, 2 );
if ( ! function_exists( 'qcld_ilist_floating_openai_article_heading_img_callback' ) ) {
function qcld_ilist_floating_openai_article_heading_img_callback( $qcld_ilist_article_text, $img_size ){
    ...
    $request_body = [
        "prompt"            => $qcld_ilist_article_text,
        "model"             => 'dall-e-3',
        "n"                 => 1,
        "size"              => $img_size,
        "response_format"   => "url",
    ...
    if( !empty($imgresult)){
        ...
        $qcld_ilist_floating_openai_images_attribution = 'gpt openai';
        ...
        $imgresult = "\n"."<img src='" . $attach_id . "' alt='" . $qcld_ilist_article_text . "' />"."\n";
