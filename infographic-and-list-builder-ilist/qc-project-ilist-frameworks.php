        ...
        <table class="form-table">
          ...
          <tr valign="top">
            ...
            <td><input type="text" name="sl_openai_api_key" size="100" value="<?php echo esc_attr( get_option('sl_openai_api_key') ); ?>"  />
              <p><i><?php echo esc_html( '**If OpenAI is not responding back and the bot is just loading, then likely you hit your OpenAI usage limit. Please pre-purchase credit to use OpenAI API and increase the Usage limit. You can add credits to your API account by visiting the ' , 'iList' ); ?> <a class="qcld_help_link" href="<?php echo esc_url('https://platform.openai.com/account/billing'); ?>" target="_blank"><?php echo esc_html( 'billing page.' , 'iList' ); ?></a></i></p>
            </td>
          </tr>
          <tr valign="top">
            ...
            <td>
              <select name="sl_openai_engines">
                <option value="gpt-4o" <?php echo (( get_option('sl_openai_engines',true) == 'gpt-4o') ? esc_attr('selected') : '') ; ?>><?php echo esc_html( 'GPT-4o' , 'iList' ); ?></option>
                <option value="gpt-4" <?php echo (( get_option('sl_openai_engines',true) == 'gpt-4') ? esc_attr('selected') : '') ; ?> ><?php echo esc_html( 'GPT-4' , 'iList' ); ?></option>
                <option value="gpt-3.5-turbo" <?php echo (( get_option('sl_openai_engines',true) == 'gpt-3.5-turbo') ? esc_attr('selected') : '') ; ?> ><?php echo esc_html( 'GPT-3 turbo' , 'iList' ); ?></option>
                <option value="gpt-3.5-turbo-instruct-0914" <?php echo (( get_option('sl_openai_engines',true) == 'gpt-3.5-turbo-instruct-0914') ? esc_attr('selected') : '') ; ?>> <?php echo esc_html( 'gpt-3.5-turbo-instruct-0914' , 'iList' ); ?> </option>
                <option value="gpt-3.5-turbo-instruct" <?php echo (( get_option('sl_openai_engines',true) == 'gpt-3.5-turbo-instruct') ? esc_attr('selected') : '') ; ?>> <?php echo esc_html( 'gpt-3.5-turbo-instruct' , 'iList' ); ?> </option>
