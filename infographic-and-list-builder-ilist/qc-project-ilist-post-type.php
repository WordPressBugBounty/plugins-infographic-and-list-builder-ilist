	...
	function qcilist_pro_custom_meta_box_openai($object){
	    ?>
	    	...
	    	<div class="qcld_openai_title_generate_wrap">
	    		...
	    		$sl_openai_api_key = get_option('sl_openai_api_key'); 
	    		if( empty( $sl_openai_api_key )){
	    		?>
	    		<p><a href="<?php echo esc_url('https://devel3/ilist-pro/wp-admin/edit.php?post_type=ilist&page=ilist_settings#openai_settings'); ?>" target="_blank" class="qcld_openai_empty_msg"> <?php echo esc_html(' API key not added. AI will not work.', 'iList' ); ?> </a> </p>
	    		<?php } ?>
